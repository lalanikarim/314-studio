...
export default function ModelSelector() {
  ...
  const { models, loading, error } = useModels(selectedFolder);
      ...
      <div className="view-models__inner">
        ...
        {loading && (
          <div className="view-models__loading">
            <svg className="view-models__spinner" viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" />
            </svg>
            <p>{error ? `${error} Showing fallback...` : 'Connecting to Pi and fetching models...'}</p>
          </div>
        )}
